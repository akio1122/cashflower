...
feature 'Sign Up', :devise do
  ...
  scenario 'visitor can sign up with valid email address and password', js: true do
    sign_up_with('test@example.com', 'han', 'solo', 'test company', 'please123', 'please123')
  ...
  scenario 'visitor cannot sign up with invalid email address' do
    sign_up_with('bogus', 'han', 'solo', 'demo', 'please123', 'please123')
  ...
  scenario 'visitor cannot sign up without password' do
    sign_up_with('test@example.com', 'han', 'solo', 'demo', '', '')
  ...
  scenario 'visitor cannot sign up with a short password' do
    sign_up_with('test@example.com', 'han', 'solo', 'demo', 'se', 'se')
  ...
  scenario 'visitor cannot sign up without password confirmation' do
    sign_up_with('test@example.com', 'han', 'solo', 'demo', '23232', '')
  ...
  scenario 'visitor cannot sign up with mismatched password and confirmation' do
    sign_up_with('test@example.com', 'han', 'solo', 'demo', 'please123', 'mismatch')
    expect(page).to have_content "Password confirmationdoesn't match"
  end
